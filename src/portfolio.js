...
const greeting = {
  ...
  subTitle:
    "Computer Science Engineer specialized in Data Science, with a Master’s in Actuarial Science. ",
  resumeLink:
  ...
  data: [
    {
      ...
      skills: [
        ...
        "Design and deploy scalable ML models for real-world problems using Random Forest, SVM, Decision Trees, and Gaussian Mixture Models.",

        "- 🔍 Anomaly Detection & Classification :",
        "Detect unusual patterns in complex datasets for cybersecurity and data quality monitoring.",

        "⚡ Deep Learning :",

        "- 🤖 Modeling & Deployment :",
        "Build deep neural networks (CNN, RNN, LSTM) for time series, computer vision, and unstructured data tasks.",

        "- 🖼️ Computer Vision :",
        "Implement CNNs for image recognition, classification, and object detection; optimize with pre-trained models like Mask RCNN.",

        "- 🚀 Performance Optimization :",
        "Enhance models with hyperparameter tuning, transfer learning, and overfitting reduction.",

        "⚡ Natural Language Processing (NLP) :",

        "- 💬 Text Analysis & Generation :",
        "Develop models for syntactic/semantic analysis, information extraction, sentiment analysis, and text classification.",

        "- 🎯 Intent Detection & Understanding :",
        "Extract meaning and intent from text for chatbots, virtual assistants, and recommendation systems.",

        "⚡ Intelligent Agents (IA Agents) :",

        "- 🤝 Chatbots & Virtual Assistants :",
        "Build intelligent assistants with speech recognition, conversation management, and API integration.",

        "⚡ GenIA (LLM – Large Language Models) :",

        "- 🛒 Recommendation Systems :",
        "Create personalized systems with LLMs and fine-tuning techniques for e-commerce, media, and streaming.",

        "- 🌐 LLM in Chatbots :",
        "Implement LLM-powered chatbots for complex queries and realistic, context-aware responses.",
      ],
      softwareSkills: [
        {
      ...
      experiences: [
        {
          ...
          company: "INOFR",
          company_url: "https://www.infor.com/mea",
          logo_path: "Infor_logo.png",
          duration: "February 2025 - August 2025",
          location: "Tunis, Tunisia",
          description:
            "⭐Developed an intelligent system for dynamic node upscaling in distributed environments using time series analysis, feature selection, and deep learning models (LSTM, GRU, Transformer) for anomaly detection. ⚡ Key Skills:Time Series Analysis, Feature Selection, LSTM, GRU, Transformer, Deep Learning.",
          color: "#000000",
        },
        {
          ...
          company_url:
            "https://www.linkedin.com/company/elite-council-consulting/posts/?feedView=all",
        ...
        },
        {
          ...
          location: "Tunis, Tunisia",
          description:
            "⭐ Designed and developed an application with a user interface for clients and administrators, featuring efficient client account management capabilities. Utilized Spring Boot for backend, Angular for frontend, and MySQL for database management.⚡ Key Skills: Spring Boot, Angular, MySQL, Full Stack Development.",
          color: "#ee3c26",
        },
      ],
    },
      ...
      experiences: [
        {
          ...
          company: "ESPRIT",
          company_url:
            "httsps://www.linkedin.com/company/esprit-career-center/posts/?feedView=all",
          logo_path: "ESPRIT.png",
        ...
        },
        {
          ...
          company: "ESPRIT",
          company_url:
            "https://www.linkedin.com/company/esprit-career-center/posts/?feedView=all",
          logo_path: "ESPRIT.png",
...

        {
          ...
          company_url: "https://ensi.rnu.tn/Anniv40ENSI/Clubs/TUNSA/index.html",
          logo_path: "ENSI.png",
  ...
  data: [
    {
      ...
      url:
        "https://medium.com/@islem.maiti/fine-tuning-techniques-for-large-language-models-llms-dfd5e66b5275",
    },
  ],
};
...
const contactPageData = {
  ...
  blogSection: {
    ...
    link:
      "https://www.google.com/maps/place/El+Ghazala/@36.8935037,10.1908708,16z/data=!3m1!4b1!4m6!3m5!1s0x12e2cb7254b0ee4f:0x7e87e33674451f9e!8m2!3d36.8950951!4d10.188536!16s%2Fg%2F1ptvwdcx4?entry=ttu&g_ep=EgoyMDI0MTEyNC4xIKXMDSoASAFQAw%3D%3D",
