...
export const blueTheme = {
  body: "#F9F9F9", // Gris clair, fond apaisant et neutre.
  text: "#333333", // Gris foncé, facile à lire pour le texte principal.
  expTxtColor: "#666666", // Gris moyen pour les textes secondaires.
  highlight: "#E0B1CB", // Rose pâle, plus doux et subtil, pour les éléments interactifs.
  dark: "#2C3E50", // Bleu-gris foncé pour les éléments importants.
  secondaryText: "#8E8E8E", // Gris clair pour les textes secondaires, subtils.
  imageHighlight: "#E29F95", // Orange clair pour les images et éléments en surbrillance.
  compImgHighlight: "#F1F1F1", // Gris très clair, presque blanc, pour les éléments d'images.
  jacketColor: "#FFB84D", // Un jaune doré doux pour les éléments qui attirent l'attention.
  headerColor: "#D35400", // Orange brûlé, moderne et chaleureux, pour le header.
  splashBg: "#800020", //
};
